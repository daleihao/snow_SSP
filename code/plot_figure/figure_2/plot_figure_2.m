...
colormap(colors_1)
plot_global_map(lats, lons,  mean_BC_RF_future_126, 0, 10,"SSP126");
...
colormap(colors_1)
plot_global_map(lats, lons, mean_BC_RF_future_585,0, 10,"SSP585");
...
colormap(colors_1)
plot_global_map(lats, lons, mean_dust_RF_future_126, 0, 10,"");
...
colormap(colors_1)
plot_global_map(lats, lons, mean_dust_RF_future_585, 0, 10,"");
...
colormap(colors_1)
plot_global_map(lats, lons, mean_AER_RF_future_126, 0, 10,"");
...
colormap(colors_1)
plot_global_map(lats, lons, mean_AER_RF_future_585, 0, 10,"");
...
set(hcb,'Position',x)
%% output
print(gcf, '-dtiff', '-r300', '../figures/figure_2.tif')
