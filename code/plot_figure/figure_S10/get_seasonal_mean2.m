...
for month_i = 1:12
    disp(month_i)
    load([dirname 'seasonal_data/Month_' num2str(month_i) '_mean_hist_run_1950_2014_Control_revise2.mat']);
    mean_BC_hist = SAR_BC_means;
    mean_dust_hist = SAR_dust_means;
    mean_AER_hist = SAR_LAP_means;
    mean_SWE_hist = SS_BC_means;
    mean_SNORDSL_hist = SS_dust_means;
    
    %% SSP126
    load([dirname 'seasonal_data/Month_' num2str(month_i) '_mean_SSP126_2015_2100_Control_revise2.mat']);
    mean_BC_2100 = SAR_BC_means;
    mean_dust_2100 = SAR_dust_means;
    mean_AER_2100 = SAR_LAP_means;
    mean_SWE_2100 = SS_BC_means;
    mean_SNORDSL_2100 = SS_dust_means;

    %%585
    
    load([dirname 'seasonal_data/Month_' num2str(month_i) '_mean_SSP585_2015_2100_Control_revise2.mat']);
      mean_BC_2100_585 = SAR_BC_means;
    mean_dust_2100_585 = SAR_dust_means;
    mean_AER_2100_585 = SAR_LAP_means;
    mean_SWE_2100_585 = SS_BC_means;
    mean_SNORDSL_2100_585 = SS_dust_means;
...
for month_i = 1:12
    ...
    %% SSP126
    load([dirname 'seasonal_data/Month_' num2str(month_i) '_mean_SSP126_2015_2100_Control_hist_BD_revise2.mat']);
    mean_BC_2100 = SAR_BC_means;
    mean_dust_2100 = SAR_dust_means;
    mean_AER_2100 = SAR_LAP_means;
    mean_SWE_2100 = SS_BC_means;
    ...
    load([dirname 'seasonal_data/Month_' num2str(month_i) '_mean_SSP585_2015_2100_Control_hist_BD_revise2.mat']);
    mean_BC_2100_585 = SAR_BC_means;
    mean_dust_2100_585 = SAR_dust_means;
    mean_AER_2100_585 = SAR_LAP_means;
    mean_SWE_2100_585 = SS_BC_means;
