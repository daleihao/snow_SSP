...
%% dust
BCs_time_series_all = nansum(BCs_time_series_all,3);
...
if(sig<0.05)
text(2076,0.05,'p<0.05','fontweight','bold','fontsize',10,'color',colors(1,:))
else
text(2076,0.05,['p=' num2str(sig,'%4.2f')],'fontweight','bold','fontsize',10,'color',colors(1,:))
end

all_BC = plot([1995:2100],mean_BC_time_series,'linewidth',2,'color',colors(1,:))
...
text(1978,0.79,'d','fontweight','bold','fontsize',12)
...
%% dust_all
dusts_time_series_all = nansum(dusts_time_series_all, 3);
...
if(sig<0.05)
text(2076,0.045,'p<0.05','fontweight','bold','fontsize',10,'color',colors(2,:))
else
text(2076,0.045,['p=' num2str(sig,'%4.2f')],'fontweight','bold','fontsize',10,'color',colors(2,:))
end
...
% patch([[1995:2100]'; flipud([1995:2100]')],[min_dust_time_series; flipud(max_dust_time_series)],colors(2,:),'LineStyle','none');
% alpha(0.3)
dry_dust = plot([1995:2100],mean_dust_time_series1,'linewidth',2,'color',colors(2,:))
...
% end
legend([dry_dust],{'Dust'},'NumColumns',1);
xlim([1995 2100])
ylim([0.03 0.25])
ylabel('\mug m^{-2} s^{-1}')
box on
text(1978,0.245,'k','fontweight','bold','fontsize',12)
...
ylabel('ng m^{-2} s^{-1}')
text(1978,0.88,'g','fontweight','bold','fontsize',12)
...
% patch([[1995:2100]'; flipud([1995:2100]')],[min_dust_time_series; flipud(max_dust_time_series)],colors(2,:),'LineStyle','none');
% alpha(0.3)
plot([1995:2100],mean_dust_time_series1,'linewidth',2,'color',colors(2,:))
...
box on
ylabel('\mug m^{-2} s^{-1}')
text(1978,0.27,'n','fontweight','bold','fontsize',12)
yyaxis right
yticks([])
ylabel('SSP585','fontweight','bold');
set(gca,'Ycolor','K');
...
%% output
print(gcf, '-dtiff', '-r300', '../figures/figure_1_v2.tif')
