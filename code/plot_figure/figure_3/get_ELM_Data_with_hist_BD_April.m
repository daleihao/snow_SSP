...
load([dirname 'April_mean_hist_run_1950_2014_PP_revise2.mat']);
mean_BC_hist_PP = RF_BC_means;
mean_dust_hist_PP = RF_dust_means;
mean_AER_hist_PP = RF_LAP_means;
mean_SWE_hist_PP = SWE_means;

load([dirname 'April_mean_hist_run_1950_2014_Koch_revise2.mat']);
...
load([dirname 'April_mean_hist_run_1950_2014_extBC_revise2.mat']);
...
load([dirname 'April_mean_hist_run_1950_2014_intDust_revise2.mat']);
...
load([dirname 'April_mean_hist_run_1950_2014_noLULCC_revise2.mat']);
...
load([dirname 'April_mean_hist_run_1950_2014_MSE_2_revise2.mat']);
...
load([dirname 'April_mean_hist_run_1950_2014_MSE_0_02_revise2.mat']);
...
load([dirname 'April_mean_SSP126_2015_2100_PP_hist_BD_revise2.mat']);
mean_BC_2100_PP = RF_BC_means;
mean_dust_2100_PP = RF_dust_means;
mean_AER_2100_PP = RF_LAP_means;
mean_SWE_2100_PP = SWE_means;

load([dirname 'April_mean_SSP126_2015_2100_Koch_hist_BD_revise2.mat']);
...
load([dirname 'April_mean_SSP126_2015_2100_extBC_hist_BD_revise2.mat']);
...
load([dirname 'April_mean_SSP126_2015_2100_intDust_hist_BD_revise2.mat']);
...
load([dirname 'April_mean_SSP126_2015_2100_noLULCC_hist_BD_revise2.mat']);
...
load([dirname 'April_mean_SSP126_2015_2100_MSE_2_hist_BD_revise2.mat']);
...
load([dirname 'April_mean_SSP126_2015_2100_MSE_0_02_hist_BD_revise2.mat']);
...
load([dirname 'April_mean_SSP585_2015_2100_PP_hist_BD_revise2.mat']);
...
load([dirname 'April_mean_SSP585_2015_2100_Koch_hist_BD_revise2.mat']);
...
load([dirname 'April_mean_SSP585_2015_2100_extBC_hist_BD_revise2.mat']);
...
load([dirname 'April_mean_SSP585_2015_2100_intDust_hist_BD_revise2.mat']);
...
load([dirname 'April_mean_SSP585_2015_2100_noLULCC_hist_BD_revise2.mat']);
...
load([dirname 'April_mean_SSP585_2015_2100_MSE_2_hist_BD_revise2.mat']);
...
load([dirname 'April_mean_SSP585_2015_2100_MSE_0_02_hist_BD_revise2.mat']);
