...
plot(1995:2100,time_series_swe_SSP126(1,:)','r-','linewidth',1.5,'color',colors(3,:))
plot(1995:2100,ELM_time_series_swe_SSP126_BD(1,:)','r-','linewidth',1.5,'color','y')
...
plot(1995:2100,ELM_time_series_swe_SSP585_BD(1,:)','r-','linewidth',1.5,'color','y')
...
print(gcf, '-dtiff', '-r300', '../../figures/figure_S7_2.tif')
