...
mean_dust_RF_hist(mean_SWE_hist<=5) = nan;
mean_dust_RF_future_126(mean_SWE_future_126<=5) = nan;
mean_dust_RF_future_585(mean_SWE_future_585<=5) = nan;

mean_AER_RF_hist(mean_SWE_hist<=5) = nan;
mean_AER_RF_future_126(mean_SWE_future_126<=5) = nan;
mean_AER_RF_future_585(mean_SWE_future_585<=5) = nan;