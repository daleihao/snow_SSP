...
export COMPILER=gnu
export MACH=pm-cpu
export CASE_NAME=SSP585_2015_2100_noLULCC_hist_BD_revise2
...
cat >> user_nl_elm << EOF
finidat = '/pscratch/sd/d/daleihao/e3sm_scratch/pm-cpu/hist_run_1950_2014_noLULCC_revise2/run/hist_run_1950_2014_noLULCC_revise2.elm.r.2015-01-01-00000.nc'
