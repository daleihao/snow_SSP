...
export COMPILER=gnu
export MACH=pm-cpu
export CASE_NAME=SSP126_2015_2100_Koch_hist_BD_revise2
...
perl -w -i -p -e "s@aerosoldep_SSP1-2.6_monthly_1849-2101_UNSET.nc@aerodep_clm_SSP_2014-2101_monthly_0.9x1.25_c190523_hist_BD.nc@" ./user_datm.streams.txt.presaero.SSP1-2.6
