...
export COMPSET=SSP585_DATM%GSWP3v1_ELM%SPBC_SICE_SOCN_MOSART_SGLC_SWAV
export COMPILER=gnu
export MACH=pm-cpu
export CASE_NAME=SSP585_2015_2100_Koch_hist_BD_revise2
...
export landuseFile=landuse.timeseries_NH_05_SSP585_c220703.nc
...
./xmlchange NTASKS=2048,STOP_N=86,STOP_OPTION=nyears,JOB_WALLCLOCK_TIME="12:00:00",RUN_STARTDATE="2015-01-01",REST_N=43,REST_OPTION=nyears
...
./xmlchange DATM_CPLHIST_DIR='/global/cfs/cdirs/m3520/share/cesm_inputdata/ssp5/monthly_data/'
...
./xmlchange DATM_CPLHIST_CASE='b.e21.BSSP585cmip6.f09_g17.CMIP6-SSP5-8.5.102'

cat >> user_nl_elm << EOF
finidat = '/pscratch/sd/d/daleihao/e3sm_scratch/pm-cpu/hist_run_1950_2014_Koch_revise2/run/hist_run_1950_2014_Koch_revise2.elm.r.2015-01-01-00000.nc'
...
cp ./CaseDocs/datm.streams.txt.co2tseries.SSP5-8.5 ./user_datm.streams.txt.co2tseries.SSP5-8.5
chmod +rw ./user_datm.streams.txt.co2tseries.SSP5-8.5
perl -w -i -p -e "s@/global/cfs/cdirs/e3sm/inputdata/atm/datm7/CO2@/global/cfs/cdirs/m3520/share/cesm_inputdata/co2@" ./user_datm.streams.txt.co2tseries.SSP5-8.5
sed -i '/ZBOT/d' ./user_datm.streams.txt.co2tseries.SSP5-8.5
...
perl -w -i -p -e "s@aerosoldep_SSP5-8.5_monthly_1849-2101_UNSET.nc@aerodep_clm_SSP_2014-2101_monthly_0.9x1.25_c190523_hist_BD.nc@" ./user_datm.streams.txt.presaero.SSP5-8.5
