...
export COMPILER=gnu
export MACH=pm-cpu
export CASE_NAME=SSP585_2015_2100_Control_hist_Dust_revise2
...
cat >> user_nl_elm << EOF
finidat = '/pscratch/sd/d/daleihao/e3sm_scratch/pm-cpu/hist_run_1950_2014_Control_revise2/run/hist_run_1950_2014_Control_revise2.elm.r.2015-01-01-00000.nc'
...
perl -w -i -p -e "s@aerosoldep_SSP5-8.5_monthly_1849-2101_UNSET.nc@aerodep_clm_SSP585_2014-2101_monthly_0.9x1.25_c190523_future_B_hist_D.nc@" ./user_datm.streams.txt.presaero.SSP5-8.5
