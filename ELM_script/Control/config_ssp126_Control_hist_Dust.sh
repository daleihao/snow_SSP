...
export COMPSET=SSP126_DATM%GSWP3v1_ELM%SPBC_SICE_SOCN_MOSART_SGLC_SWAV
export COMPILER=gnu
export MACH=pm-cpu
export CASE_NAME=SSP126_2015_2100_Control_hist_Dust_revise2
...
perl -w -i -p -e "s@aerosoldep_SSP1-2.6_monthly_1849-2101_UNSET.nc@aerodep_clm_SSP126_2014-2101_monthly_0.9x1.25_c190523_future_B_hist_D.nc@" ./user_datm.streams.txt.presaero.SSP1-2.6
